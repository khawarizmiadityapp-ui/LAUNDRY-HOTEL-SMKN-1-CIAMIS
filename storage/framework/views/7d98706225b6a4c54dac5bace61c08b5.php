<?php $__env->startSection('title', 'Manajemen Customer'); ?>
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
    ...
    <?php if (isset($component)) { $__componentOriginal961c78fce8987d4f07ef63ed70f0d225 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal961c78fce8987d4f07ef63ed70f0d225 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stat-cardcustomer','data' => ['title' => 'Total Customer','value' => ''.e(number_format($stats['total_customer'])).'','badge' => '12%','badgeUp' => true,'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-cardcustomer'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Total Customer','value' => ''.e(number_format($stats['total_customer'])).'','badge' => '12%','badgeUp' => true,'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal961c78fce8987d4f07ef63ed70f0d225)): ?>
<?php $attributes = $__attributesOriginal961c78fce8987d4f07ef63ed70f0d225; ?>
<?php unset($__attributesOriginal961c78fce8987d4f07ef63ed70f0d225); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal961c78fce8987d4f07ef63ed70f0d225)): ?>
<?php $component = $__componentOriginal961c78fce8987d4f07ef63ed70f0d225; ?>
<?php unset($__componentOriginal961c78fce8987d4f07ef63ed70f0d225); ?>
<?php endif; ?>

    
    <?php if (isset($component)) { $__componentOriginal961c78fce8987d4f07ef63ed70f0d225 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal961c78fce8987d4f07ef63ed70f0d225 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stat-cardcustomer','data' => ['title' => 'Customer Aktif Bulan Ini','value' => ''.e(number_format($stats['aktif_bulan_ini'])).'','subtitle' => 'Target: 400','icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stat-cardcustomer'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Customer Aktif Bulan Ini','value' => ''.e(number_format($stats['aktif_bulan_ini'])).'','subtitle' => 'Target: 400','icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal961c78fce8987d4f07ef63ed70f0d225)): ?>
<?php $attributes = $__attributesOriginal961c78fce8987d4f07ef63ed70f0d225; ?>
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-5 border-b border-slate-100">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-0.5">
                Menampilkan <?php echo e($customers->firstItem()); ?>–<?php echo e($customers->lastItem()); ?> dari <?php echo e(number_format($customers->total())); ?> customer
            </p>
        </div>
        <form method="GET" action="<?php echo e(route('admin.customers.index')); ?>" class="flex items-center gap-2">
            <input type="text"
                   name="search"
            ...
            <?php if(!empty($search)): ?>
                <a href="<?php echo e(route('admin.customers.index')); ?>" class="inline-flex items-center gap-1.5 px-4 py-2 border border-slate-200 rounded-xl text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-all duration-200">
                    Reset
                </a>
            <?php endif; ?>
        </form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="table-row border-b border-slate-50 last:border-0">
                    ...
                    <td class="px-6 py-4">
                        <span class="text-brand-600 font-bold text-xs">#<?php echo e($customer->id); ?></span>
                    </td>
                    
                    <td class="px-4 py-4">
                        <div>
                            <p class="font-semibold text-slate-800 leading-tight"><?php echo e($customer->nama); ?></p>
                            <p class="text-[11px] text-slate-400"><?php echo e($customer->email ?? '-'); ?></p>
                        </div>
                    </td>
                    
                    <td class="px-4 py-4 text-slate-600 font-medium"><?php echo e($customer->no_hp ?? '-'); ?></td>
                    
                    <td class="px-4 py-4 text-slate-500 text-xs leading-relaxed">
                        <?php if($customer->terakhir_transaksi): ?>
                            <?php echo e(\Carbon\Carbon::parse($customer->terakhir_transaksi)->translatedFormat('d M Y, H:i')); ?>
                    ...
                    <td class="px-4 py-4">
                        <span class="font-bold text-slate-800"><?php echo e($customer->total_order ?? 0); ?></span>
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="relative inline-block text-left">
                            <button onclick="toggleDropdown('dropdown-<?php echo e($customer->id); ?>')"
                            ...
                            <div id="dropdown-<?php echo e($customer->id); ?>" class="hidden absolute right-0 top-full mt-1 w-40 bg-white rounded-xl shadow-xl border border-slate-100 z-50 py-1.5">
                                
                                <button type="button" onclick="openEditCustomerModal(<?php echo e($customer->id); ?>, '<?php echo e(addslashes($customer->nama)); ?>', '<?php echo e(addslashes($customer->no_hp)); ?>', '<?php echo e(addslashes($customer->email)); ?>', '<?php echo e(preg_replace('/\r|\n/', ' ', addslashes($customer->alamat))); ?>')" 
    ...
    <div class="px-6 py-4 border-t border-slate-100">
        <?php echo e($customers->onEachSide(1)->links('vendor.pagination.custom')); ?>
...
<div id="editCustomerModal" class="hidden fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="edit_alamat" name="alamat" rows="3"
                              class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none"></textarea>
                </div>
                <div class="mt-6 flex items-center justify-end gap-3">
                    <button type="button" onclick="closeEditCustomerModal()"
                            class="px-5 py-2 text-sm font-semibold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition">
                        Batal
                    </button>
                    <button type="submit"
                            class="inline-flex items-center gap-2 px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white font-bold text-sm rounded-xl shadow-md transition-all">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
...
<?php echo $__env->make('layouts.' . (auth()->user()->role === 'admin' ? 'admin' : 'petugas_piket'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Adobe\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>