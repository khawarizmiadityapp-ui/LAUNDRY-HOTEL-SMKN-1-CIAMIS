    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center gap-3 group">
                <img src="<?php echo e($logoImage); ?>" alt="Bening Laundry Logo" class="w-12 h-12 object-contain group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-50 mb-8 mt-4">
                <div class="bg-emerald-500 text-white rounded-2xl p-6 shadow-xl flex flex-col md:flex-row items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-50 font-medium"><?php echo e(Session::get('success')); ?></p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="text-center md:text-left md:flex items-center gap-12">
                <div class="flex-1 space-y-6">
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-4">
                        <a href="https://wa.me/<?php echo e($serviceWA); ?>?text=Halo%20Bening%20Laundry,%20saya%20ingin%20memesan%20layanan%20laundry." target="_blank" class="px-8 py-4 bg-sky-500 text-white rounded-2xl font-bold shadow-lg shadow-sky-500/30 hover:bg-sky-600 hover:-translate-y-1 transition-all flex items-center gap-2">
                            Pesan Layanan
                ...
                <div class="hidden md:block flex-1 relative">
                    ...
                    <div class="relative w-full aspect-square rounded-[3rem] bg-slate-100 overflow-hidden shadow-2xl rotate-3 transition-transform hover:rotate-0 duration-500 group">
                         ...
                         <img src="<?php echo e($heroImage); ?>" alt="Laundry Services" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    </div>
    ...
    <section id="services" class="py-24 bg-white relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $layanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:border-sky-200 hover:shadow-2xl hover:shadow-sky-100/50 hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-xl font-bold text-slate-800 mb-2"><?php echo e($svc->nama); ?></h3>
                    <div class="flex items-baseline gap-1 mb-4">
                        <span class="text-2xl font-800 text-sky-500 font-extrabold">Rp<?php echo e(number_format($svc->harga, 0, ',', '.')); ?></span>
                        <span class="text-xs text-slate-400 font-semibold uppercase tracking-wider"><?php echo e($svc->satuan); ?></span>
                    </div>
                    <?php if($svc->estimasi): ?>
                    <div class="flex items-center gap-2 text-xs font-semibold text-slate-500">
                        ...
                        Estimasi <?php echo e($svc->estimasi_label); ?>
    ...
    <section id="tracking" class="py-24 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="bg-white/10 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-8 md:p-12 border border-white/20">
                ...
                <form action="<?php echo e(route('track.status')); ?>" method="GET" class="space-y-4">
                    <div class="relative group">
                        ...
                        <input 
                            ...
                            name="nota_number" 
                            required
                            value="<?php echo e(old('nota_number')); ?>"
                    ...
                    <?php if(Session::has('error')): ?>
                        <p class="text-center text-sm font-semibold text-red-500 mt-4"><?php echo e(Session::get('error')); ?></p>
                    <?php endif; ?>
                </form>
            </div>
        </div>
    ...
    <footer class="bg-slate-900 pt-20 pb-10 text-white overflow-hidden relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
                <div class="space-y-6">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e($logoImage); ?>" alt="Bening Laundry Logo" class="w-12 h-12 object-contain bg-white rounded-xl shadow-lg">
                ...
                <div class="space-y-6">
                    ...
                    <a href="https://wa.me/<?php echo e($adminWA); ?>" target="_blank" class="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold"><?php echo e($formattedWA); ?></p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-xs text-slate-500">© <?php echo e(date('Y')); ?> SMKN 1 Ciamis Laundry. Semua hak dilindungi.</p>
...
<?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/welcome.blade.php ENDPATH**/ ?>