                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="relative inline-block text-left">
                                <button type="button" 
                                        onclick="toggleDropdown('dropdown-kategori-<?php echo e($kategori->id); ?>')" 
                                ...
                                <div id="dropdown-kategori-<?php echo e($kategori->id); ?>" 
                                    ...
                                    <button type="button" 
                                            onclick="editKategori(<?php echo e($kategori->id); ?>, '<?php echo e(addslashes($kategori->nama)); ?>', '<?php echo e(addslashes($kategori->deskripsi ?? '')); ?>', <?php echo e($kategori->is_active ? 'true' : 'false'); ?>); document.getElementById('dropdown-kategori-<?php echo e($kategori->id); ?>').classList.add('hidden')" 
                                    ...
                                    <form action="<?php echo e(route('admin.kategori-pengeluaran.toggle-status', $kategori)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <button type="submit" 
                                                class="w-full flex items-center gap-2.5 px-4 py-2 text-xs font-semibold <?php echo e($kategori->is_active ? 'text-amber-600 hover:bg-amber-50' : 'text-emerald-600 hover:bg-emerald-50'); ?> transition-colors">
                                            <?php if($kategori->is_active): ?>
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    ...
                                    <form action="<?php echo e(route('admin.kategori-pengeluaran.destroy', $kategori)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                        <?php echo csrf_field(); ?>
