...
<script>
    function petugasManager() {
        const initialPetugas = <?php echo json_encode($petugasData ?? [], 15, 512) ?>;
        ...
        return {
            ...
            async saveNewPetugas() {
                try {
                    const response = await fetch('<?php echo e(route("admin.petugas.store")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/petugas/index.blade.php ENDPATH**/ ?>