...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
    ...
    <a href="<?php echo e(route('admin.customers.index')); ?>" class="text-slate-500 hover:text-brand-600 font-medium text-sm transition-colors">
        &larr; Kembali
    </a>
</div>
    ...
    <form action="<?php echo e(route('admin.customers.update', $customer->id)); ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $customer->nama)); ?>" required
            ...
            <div>
                ...
                <input type="text" id="no_hp" name="no_hp" value="<?php echo e(old('no_hp', $customer->no_hp)); ?>" required
                       class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none">
            </div>
        </div>
        <div class="mt-5">
        ...
        <div class="mt-5">
            ...
            <textarea id="alamat" name="alamat" rows="3"
                      class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none"><?php echo e(old('alamat', $customer->alamat)); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.' . (auth()->user()->role === 'admin' ? 'admin' : 'petugas_piket'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Adobe\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/customers/edit.blade.php ENDPATH**/ ?>