...
<div x-data="jadwalPetugasManager()" class="space-y-6 animate-fade-in">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="flex items-center gap-2">
                        ...
                        <span class="px-2.5 py-0.5 bg-blue-100 text-blue-700 text-xs font-bold rounded-full">Perhotelan</span>
                    </div>
                    <p class="text-slate-500 text-sm mt-0.5">Program Keahlian Perhotelan (Kelas XI HOTEL-1 & HOTEL-2) • SMKN 1 Ciamis</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        <div class="bg-white p-3.5 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <p class="text-xl font-black text-slate-800 mt-1"><?php echo e($statsToday['total']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-emerald-100 shadow-sm">
            ...
            <p class="text-xl font-black text-emerald-700 mt-1"><?php echo e($statsToday['checked_in']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-blue-100 shadow-sm">
            ...
            <p class="text-xl font-black text-blue-700 mt-1"><?php echo e($statsToday['washing']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-amber-100 shadow-sm">
            ...
            <p class="text-xl font-black text-amber-700 mt-1"><?php echo e($statsToday['setrika']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-purple-100 shadow-sm">
            ...
            <p class="text-xl font-black text-purple-700 mt-1"><?php echo e($statsToday['packing']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-emerald-100 shadow-sm">
            ...
            <p class="text-xl font-black text-emerald-700 mt-1"><?php echo e($statsToday['kasir']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-indigo-100 shadow-sm">
            ...
            <p class="text-xl font-black text-indigo-700 mt-1"><?php echo e($statsToday['inventory']); ?></p>
        ...
        <div class="bg-white p-3.5 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <p class="text-xl font-black text-slate-500 mt-1"><?php echo e($statsToday['pending_checkin']); ?></p>
        ...
        <form method="GET" action="<?php echo e(route('admin.jadwal.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3.5 items-end">
            ...
            <div>
                ...
                <select name="station" class="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-slate-50"
                    ...
                    <option value="kasir" <?php echo e(request('station') == 'kasir' ? 'selected' : ''); ?>>🏪 Kasir (CS)</option>
                    <option value="inventory" <?php echo e(request('station') == 'inventory' ? 'selected' : ''); ?>>📋 Inventory</option>
                ...
                <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-3.5 px-4">
                            ...
                            <?php elseif($item->selected_station === 'inventory'): ?>
            ...
            <form action="<?php echo e(route('admin.jadwal.import')); ?>" method="POST" enctype="multipart/form-data" class="mt-4 space-y-4">
                ...
                <div class="bg-blue-50/60 p-4 rounded-xl border border-blue-100 text-xs text-blue-800 space-y-2.5">
                    <p class="font-bold flex items-center gap-1.5">
                        ...
                        Petunjuk Format Import Excel:
                    </p>
                    <ul class="list-disc pl-4 space-y-1 text-slate-600">
                        <li>File wajib berformat <strong>.xlsx</strong> atau <strong>.csv</strong>.</li>
                        <li>Template dilengkapi kop judul: <strong>JADWAL PIKET HARIAN MURID - PROGRAM KEAHLIAN PERHOTELAN (2026/2027)</strong>.</li>
                        <li>Kolom format Excel: <strong>Tanggal, Nama Siswa / Petugas, ID / NIS, Shift, Kelas / Keterangan</strong>.</li>
                    ...
                    <div class="p-2.5 bg-white rounded-xl border border-blue-100 text-[11px] text-slate-600">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="flex items-center gap-2 p-1.5 bg-blue-50/60 rounded-lg border border-blue-100">
                                <span class="w-2 h-2 rounded-full bg-blue-600"></span>
                                <span><strong>HOTEL-1</strong> (Kelas XI Hotel 1)</span>
                            </div>
                            <div class="flex items-center gap-2 p-1.5 bg-indigo-50/60 rounded-lg border border-indigo-100">
                                <span class="w-2 h-2 rounded-full bg-indigo-600"></span>
                                <span><strong>HOTEL-2</strong> (Kelas XI Hotel 2)</span>
                            </div>
                        </div>
                    </div>
    ...
    <div x-show="openAddModal" x-cloak 
        ...
        <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl animate-scale-up">
            ...
            <form action="<?php echo e(route('admin.jadwal.store')); ?>" method="POST" class="mt-4 space-y-4">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1.5">Kelas Perhotelan</label>
                    <select name="keterangan" class="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-sm bg-slate-50 focus:bg-white">
                        <option value="HOTEL-1">HOTEL-1 (Kelas XI Hotel 1)</option>
                        <option value="HOTEL-2">HOTEL-2 (Kelas XI Hotel 2)</option>
                    </select>
                </div>
    ...
    <div x-show="openEditModal" x-cloak 
        ...
        <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl animate-scale-up">
            ...
            <form :action="'<?php echo e(url('/admin/jadwal-petugas')); ?>/' + editingItem.id" method="POST" class="mt-4 space-y-4">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1.5">Kelas Perhotelan</label>
                    <select name="keterangan" x-model="editingItem.keterangan" class="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-sm bg-slate-50 focus:bg-white">
                        <option value="HOTEL-1">HOTEL-1 (Kelas XI Hotel 1)</option>
                        <option value="HOTEL-2">HOTEL-2 (Kelas XI Hotel 2)</option>
                    </select>
                </div>
