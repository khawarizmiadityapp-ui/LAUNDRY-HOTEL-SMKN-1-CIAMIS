...
<div class="text-center">
    ...
    <?php if(isset($filter)): ?>
        <div class="filter-report">Periode: <?php echo e(str_replace('_', ' ', ucfirst($filter))); ?></div>
    <?php endif; ?>
</div>
...
<table>
    ...
    <tbody>
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($trx->transaksi_code); ?></td>
            <td><?php echo e($trx->customer_name); ?></td>
            <td><?php echo e(ucfirst($trx->service_type)); ?></td>
            <td><?php echo e($trx->weight); ?> kg</td>
            <td>Rp <?php echo e(number_format($trx->total_price, 0, ',', '.')); ?></td>
            <td><?php echo e(ucfirst($trx->status)); ?></td>
            <td><?php echo e(str_replace('_', ' ', ucfirst($trx->payment_status))); ?></td>
...
<div class="signature-section clearfix">
    <div class="signature-box">
        <div class="signature-date">Ciamis, <?php echo e(\Carbon\Carbon::now()->format('d F Y')); ?></div>
        <div>Mengetahui,</div>
        <br><br><br>
...
</html><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/pdf/transaksi.blade.php ENDPATH**/ ?>