...
<div x-data="jadwalPetugasManager()" class="space-y-6 animate-fade-in">
    ...
    <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
        <form method="GET" action="<?php echo e(route('admin.jadwal.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
            <div>
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-3.5 px-4 text-right">
                            <div class="flex items-center justify-end gap-1.5">
                                <button @click="editJadwal(<?php echo e(json_encode($item)); ?>)" 
                                ...
                                <form action="<?php echo e(route('admin.jadwal.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus jadwal untuk <?php echo e($item->nama); ?>?');" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/jadwal_petugas/index.blade.php ENDPATH**/ ?>