    ...
    <form action="<?php echo e(route('admin.customers.store')); ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="tel" id="no_hp" name="no_hp" @input="no_hp = no_hp.replace(/[^0-9]/g, '')" value="<?php echo e(old('no_hp')); ?>" inputmode="numeric" required
                       class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none">
            </div>
        </div>
        <div class="mt-5">
        ...
        <div class="mt-5">
            ...
            <textarea id="alamat" name="alamat" rows="3"
                      class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all outline-none"><?php echo e(old('alamat')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.' . (auth()->user()->isAdmin() ? 'admin' : 'petugas_piket'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/customers/create.blade.php ENDPATH**/ ?>