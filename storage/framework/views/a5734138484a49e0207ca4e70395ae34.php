        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight mb-2">
                    Selamat Datang, Petugas <?php echo e(ucfirst($division ?? 'Piket')); ?>!
                </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-5 hover:shadow-md transition-shadow duration-300">
            ...
            <div>
                ...
                <div class="flex items-baseline gap-2">
                    <h2 class="text-3xl font-extrabold text-slate-800"><?php echo e($pendingTasks ?? 0); ?></h2>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-5 hover:shadow-md transition-shadow duration-300">
            ...
            <div>
                ...
                <div class="flex items-baseline gap-2">
                    <h2 class="text-3xl font-extrabold text-slate-800"><?php echo e($completedToday ?? 0); ?></h2>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.petugas_piket', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Adobe\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/petugas_piket/dashboard.blade.php ENDPATH**/ ?>