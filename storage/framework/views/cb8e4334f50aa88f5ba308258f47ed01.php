...
<body>
    ...
    <a id="waLink" href="https://wa.me/<?php echo e($waPhone); ?>?text=<?php echo e(urlencode($waMessage)); ?>" style="display:none;"></a>
        ...
        <div class="nota-body">
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <span><?php echo e($transaksi->customer_name); ?></span>
                </div>
                <div class="info-row">
                    <label>No. HP</label>
                    <span><?php echo e($transaksi->customer_phone); ?></span>
                </div>
                <div class="info-row">
                    <label>Tanggal</label>
                    <span><?php echo e($transaksi->created_at->format('d/m/Y H:i')); ?></span>
                </div>
                <div class="info-row">
                    <label>Kasir</label>
                ...
                <div class="info-row" style="margin-top: 4px; padding-top: 4px; border-top: 1px dotted #ddd;">
                    ...
                    <span><?php echo e($estimasiSelesai->format('d/m/Y H:i')); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="item-list">
                <?php $__empty_1 = true; $__currentLoopData = $transaksi->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="item-row">
                    <div class="item-name"><?php echo e($detail->layanan->nama ?? 'Layanan'); ?></div>
                    <div class="item-calc-row">
                        <span><?php echo e(rtrim(rtrim(number_format($detail->qty, 2, ',', '.'), '0'), ',')); ?> x Rp <?php echo e(number_format($detail->price, 0, ',', '.')); ?></span>
                        <span>Rp <?php echo e(number_format($detail->subtotal, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="item-row">
                    <div class="item-name"><?php echo e(ucfirst($transaksi->service_type)); ?></div>
                    <div class="item-calc-row">
                        <span><?php echo e($transaksi->weight); ?>kg x Rp <?php echo e(number_format($transaksi->price_per_kg, 0, ',', '.')); ?></span>
                        <span>Rp <?php echo e(number_format($transaksi->total_price, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="totals">
                ...
                <div class="totals-row">
                    <span>Diskon</span>
                    <span>-Rp <?php echo e(number_format($transaksi->discount, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="totals-row" style="font-size: 0.75rem;">
                    <span>Kembalian</span>
                    <span>Rp <?php echo e(number_format($transaksi->kembalian, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/pos/nota.blade.php ENDPATH**/ ?>