...
<div x-data="posApp()" x-init="init()" class="flex flex-col lg:flex-row gap-0 -mx-5 lg:-mx-8 -my-8 <?php echo e(auth()->user()->isAdmin() ? 'h-[calc(100vh-4rem)] lg:h-[calc(100vh-4rem)] overflow-hidden' : 'min-h-[calc(100vh-4rem)] lg:min-h-[calc(100vh-4rem)]'); ?>">
...
<?php echo $__env->make(auth()->user()->isAdmin() ? 'layouts.admin' : 'layouts.petugas_piket', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/pos/index.blade.php ENDPATH**/ ?>