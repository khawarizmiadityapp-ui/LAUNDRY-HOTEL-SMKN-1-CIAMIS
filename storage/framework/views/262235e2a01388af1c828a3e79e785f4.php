...
<head>
    <meta charset="UTF-8">
    <title>BKU TEFA HTL - <?php echo e($periodeJudul); ?></title>
    <style>
        @page {
            size: A4 portrait;
...
<body>
    ...
    <table class="bku-table">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $ledgerItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="text-left"><?php echo e($item['tanggal']); ?></td>
                <td class="text-center"><?php echo e($item['no_bukti']); ?></td>
                <td class="text-left"><?php echo e($item['keterangan']); ?></td>
                <td class="text-center"><?php echo e($item['ref']); ?></td>
                <td class="text-right currency-cell">
                    <?php echo e($item['debet'] > 0 ? 'Rp ' . number_format($item['debet'], 0, ',', '.') : ''); ?>
...
<?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/pdf/bku.blade.php ENDPATH**/ ?>