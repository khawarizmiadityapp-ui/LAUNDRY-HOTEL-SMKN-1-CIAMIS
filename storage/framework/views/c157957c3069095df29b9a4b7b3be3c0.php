<?php $__env->startSection('title', 'Setrika Operations'); ?>
                    ...
                    <table class="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr class="bg-slate-50 text-slate-500 text-xs uppercase tracking-wider border-b border-slate-200">
                                <th class="px-6 py-4 rounded-tl-xl w-14 text-center">
                                ...
                                <th class="px-6 py-4 font-semibold">Kode & Pelanggan</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-slate-50/50 transition-colors cursor-pointer" :class="{ 'bg-blue-50/50': selectedIds.includes(<?php echo e($trx->id); ?>) }" @click="const cb = $el.querySelector('input[type=checkbox]'); if(cb && $event.target.tagName !== 'INPUT' && $event.target.tagName !== 'BUTTON' && $event.target.tagName !== 'SELECT') { cb.click(); }">
                                    <td class="px-6 py-5 align-top text-center" @click.stop>
                                    ...
                                    <td class="px-6 py-5 align-top">
                                        ...
                                        <h3 class="font-bold text-lg text-slate-800 leading-tight"><?php echo e($trx->customer_name); ?></h3>
                                    </td>
                                    <td class="px-6 py-5 align-top">
                                        <div class="font-bold text-slate-800 capitalize mb-1"><?php echo e($trx->service_type); ?></div>
                                        <div class="text-sm text-slate-500"><?php echo e(number_format($trx->weight,1)); ?> kg</div>
                                    </td>
                                    <td class="px-6 py-5 align-top">
                                        <div class="text-sm font-semibold text-slate-600"><?php echo e($trx->created_at->diffForHumans()); ?></div>
                                        <div class="text-[10px] text-slate-400 uppercase tracking-wider mt-1">Masuk</div>
                                    </td>
                                    <td class="px-6 py-5 align-top">
                                        <form action="<?php echo e(route('petugas_piket.tasks.complete', $trx->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
            ...
            <div x-show="selectedIds.length > 0" x-transition.opacity
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400">Pilih petugas untuk menyelesaikan semuanya</p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.petugas_piket', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/petugas_piket/setrika/index.blade.php ENDPATH**/ ?>