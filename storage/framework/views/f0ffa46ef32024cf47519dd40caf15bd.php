<?php $__env->startSection('title', 'Manajemen Pembayaran - Bening Laundry'); ?>
...
<div class="p-6 md:p-8" x-data="pembayaranApp()">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1">Rp <?php echo e(number_format($totalPendapatanHariIni, 0, ',', '.')); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1"><?php echo e($transaksiBelumLunas); ?> Transaksi</p>
                    </div>
                    <i class="fas fa-exclamation-circle text-red-500 text-2xl"></i>
                </div>
                <div class="mt-4">
                    <a href="<?php echo e(route('admin.pembayaran.index', array_merge(request()->except('status'), ['status' => 'belum_bayar']))); ?>" class="text-red-600 hover:text-red-800 text-sm font-medium">
        ...
        <div class="flex space-x-2 border-b mb-6">
            <a href="<?php echo e(route('admin.pembayaran.index', array_merge(request()->except('status'), ['status' => null]))); ?>" 
               class="px-5 py-2 text-sm font-medium rounded-t-lg transition <?php echo e(!request('status') ? 'bg-white text-blue-700 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>">
                Semua
            </a>
            <a href="<?php echo e(route('admin.pembayaran.index', array_merge(request()->except('status'), ['status' => 'lunas']))); ?>" 
               class="px-5 py-2 text-sm font-medium rounded-t-lg transition <?php echo e(request('status') == 'lunas' ? 'bg-white text-blue-700 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>">
                Lunas
            </a>
            <a href="<?php echo e(route('admin.pembayaran.index', array_merge(request()->except('status'), ['status' => 'belum_bayar']))); ?>" 
               class="px-5 py-2 text-sm font-medium rounded-t-lg transition <?php echo e(request('status') == 'belum_bayar' ? 'bg-white text-blue-700 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>">
                Belum Lunas
            </a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-mono font-medium text-gray-900"><?php echo e($trx->transaksi_code); ?></td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($trx->customer_name); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e(ucfirst($trx->service_type)); ?> - <?php echo e($trx->weight); ?> kg</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800">Rp <?php echo e(number_format($trx->total_price, 0, ',', '.')); ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="relative inline-block text-left">
                                    <button onclick="toggleDropdown('dropdown-pembayaran-<?php echo e($trx->id); ?>')"
                                    ...
                                    <div id="dropdown-pembayaran-<?php echo e($trx->id); ?>" class="hidden absolute right-0 top-full mt-1 w-40 bg-white rounded-xl shadow-xl border border-slate-100 z-50 py-1.5">
                                        <?php if($trx->payment_status != 'lunas'): ?>
                                        ...
                                        <?php endif; ?>
                                        <button type="button" @click="openNota('<?php echo e(route('pos.nota', $trx->id)); ?>'); toggleDropdown('dropdown-pembayaran-<?php echo e($trx->id); ?>')"
            ...
            <div class="px-6 py-4 border-t border-gray-100">
                <?php echo e($transactions->appends(request()->query())->onEachSide(1)->links('vendor.pagination.custom')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-HOTEL-SMKN-1-CIAMIS\resources\views/admin/pembayaran/index.blade.php ENDPATH**/ ?>