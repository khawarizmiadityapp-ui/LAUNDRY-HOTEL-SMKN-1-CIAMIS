...
<div class="px-4 py-8 max-w-7xl mx-auto">
    <div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Setrika Operations</h1>
            <p class="text-slate-500 mt-1">Daftar pesanan yang saat ini sedang dalam proses setrika.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        @empty
            <div class="col-span-full py-12 flex flex-col items-center justify-center bg-slate-50 border border-slate-200 border-dashed rounded-2xl">
                ...
                <p class="text-slate-500 font-medium text-center">Tidak ada pesanan untuk disetrika saat ini.</p>
            </div>
        @endforelse
    </div>
</div>
