...
<body class="min-h-screen bg-login flex flex-col items-center justify-center py-8 px-4">
    ...
    <div class="flex items-center gap-3 mb-6">
        <img src="{{ asset('images/logo-bening.png') }}" alt="Logo Bening Laundry" class="w-11 h-11 object-contain drop-shadow-sm">
        <div>
    ...
    <div class="w-full max-w-[530px]">
        <div class="glass-card rounded-[28px] shadow-2xl p-6 sm:p-8 border border-white/80">
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5">
                    ...
                    <div class="flex flex-col items-center shrink-0">
                        <div class="p-2 bg-white rounded-2xl border border-slate-200 shadow-2xs">
                            <img src="{{ $qrCodeUrl }}" alt="QR Code Google Authenticator" class="w-32 h-32 sm:w-36 sm:h-36 object-contain rounded-lg">
                        </div>
                        ...
                        <div class="flex items-start gap-2.5">
                            ...
                            <div class="space-y-1.5 w-full">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" onclick="copySecretKey('{{ $rawSecret }}', this)" 
            ...
            <!-- OTP Input Form -->
            <form id="otpForm" action="{{ route('login.2fa.verify') }}" method="POST" class="space-y-4">
                @csrf
            ...
            <form id="cancelForm" action="{{ route('login.2fa.cancel') }}" method="POST" class="hidden">
                @csrf
            </form>
        ...
        <p class="text-center text-xs text-slate-400 mt-5">
            &copy; {{ date('Y') }} Bening Laundry SMKN 1 Ciamis • Sistem Keamanan Terpadu
        </p>
    </div>
